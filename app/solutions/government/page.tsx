      ...
      <main className="flex-1 pt-24 pb-24">
        ...
        <section className="container mx-auto px-6 lg:px-12 max-w-4xl py-16 lg:py-24">
          ...
          <p className="text-lg text-neutral-600 leading-relaxed mb-8">
            Durable, regulation-compliant furniture for government offices, public institutions,
            and civic buildings. We have a proven track record of delivering large-scale government
