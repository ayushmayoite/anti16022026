      ...
      <main className="flex-1 pt-24 pb-24">
        ...
        <section className="container mx-auto px-6 lg:px-12 max-w-4xl py-16 lg:py-24">
          ...
          <p className="text-lg text-neutral-600 leading-relaxed mb-8">
            Flexible, modern furniture for classrooms, lecture halls, libraries, and administrative
            offices. Designed to foster learning and collaboration in educational environments.
          </p>
        </section>
      </main>
      <Footer />
