      ...
      <main className="flex-1 pt-24 pb-24">
        ...
        <section className="container mx-auto px-6 lg:px-12 max-w-4xl py-16 lg:py-24">
          ...
          <p className="text-lg text-neutral-600 leading-relaxed mb-8">
            Expert guides for space planning, ergonomic setup, and creating productive work environments.
            Free resources for architects, designers, and facility managers.
          </p>
        </section>
      </main>
      <Footer />
