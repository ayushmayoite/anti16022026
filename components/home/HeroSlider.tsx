    ...
    <section className="relative h-screen min-h-[600px] bg-neutral-900 overflow-hidden">
      ...
      >
        <div className="container mx-auto px-6 lg:px-12 pb-20 md:pb-28">
          ...
          <Link
            href={slide.cta.href}
            className="inline-flex items-center gap-2 text-white text-sm font-medium border border-white/60 px-8 py-3.5 hover:bg-white hover:text-neutral-900 transition-all duration-300"
          >
            {slide.cta.text}
